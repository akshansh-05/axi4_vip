// File: axi_ram_env.sv
// Description: Dedicated Block-Level UVM Environment for Standalone AXI4 RAM verification.
//              Instantiates AXI-MM Write/Read agents, Coverage Model, and Scoreboard.

`ifndef AXI_RAM_ENV_SV
`define AXI_RAM_ENV_SV
...
class axi_ram_env #(
    ...
    `uvm_component_param_utils(axi_ram_env #(DATA_WIDTH, ADDR_WIDTH, ID_WIDTH, STRB_WIDTH))

    function new(string name = "axi_ram_env", uvm_component parent = null);
    ...
    virtual function void connect_phase(uvm_phase phase);
        ...
        // Connect Write and Read Monitor analysis ports to Coverage Subscriber
...
endclass : axi_ram_env

`endif // AXI_RAM_ENV_SV
